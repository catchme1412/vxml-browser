...
public class VxmlScriptEngine {
	...
	public VxmlScriptEngine() throws ScriptException {
		...
		scriptEngine.eval("application.ANI='197336895001';");
		...
		scriptEngine.eval("function simpleJsonParse(j){var ar = j.toString().substring(1,j.length-1);"
				+ "var arr=ar.split(':');var m={};m[arr[0]]=m[arr[1]];return m;}");
	}
